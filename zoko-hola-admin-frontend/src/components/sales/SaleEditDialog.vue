<template>
  ...
  >
    <q-card class="sale-edit-dialog column no-wrap" :class="{ 'sale-edit-dialog--mobile': $q.screen.lt.sm }">
      <q-card-section class="row items-center no-wrap q-px-lg q-py-md bg-white"
        ><q-avatar color="yellow-9" text-color="dark" icon="edit_note" />
        <div class="q-ml-md">
          <div class="text-h6 text-weight-bold">Editar venta</div>
          <div class="text-caption text-grey-7">
            Actualiza el pago, la entrega y los productos.
          </div>
        </div>
        <q-space /><q-btn
          icon="close"
      ...
      >
          ...
          <div class="row q-col-gutter-lg">
            <div class="col-12 col-md-7">
              <q-card
                flat
                bordered
                class="sale-edit-panel q-pa-md bg-white"
              >
                <div class="row items-start q-gutter-sm q-mb-md">
                  ...
                  <div>
                    ...
                    <div class="text-caption text-grey-7">
                      Revisa los montos recibidos y el costo de entrega.
                    </div>
                  </div>
                </div>
              ...
              <q-card
                flat
                bordered
                class="sale-edit-panel q-pa-md q-mt-lg bg-white"
              >
                <div class="row items-start q-gutter-sm q-mb-md">
                  ...
                  <div>
                    ...
                    <div class="text-caption text-grey-7">
                      Mantén actualizados el estado y las personas responsables.
                    </div>
                  </div>
                </div>
                <div class="row q-col-gutter-md">
                  ...
                  <div v-if="canSelectMessenger" class="col-12 col-sm-6">
                    <q-select
                      ...
                      lazy-rules
                      :disable="formData.state === 'Finalizado' && !isAdmin"
                    />
                  </div>
                  <div class="col-12 col-sm-6">
                    <q-select
            ...
            <div class="col-12 col-md-5">
              <q-card flat bordered class="sale-edit-panel bg-white"
                ...
                ><q-separator /><q-card-section
                  class="sale-edit-product-list q-pa-none scroll"
                  ><div
                  ...
                  >
                    ...
                    <div class="text-caption q-mt-xs">
                      Usa Agregar para incluir productos en la venta.
                    </div>
                  </div>
                      ...
                      ><q-item-section avatar
                        ><q-avatar size="48px" rounded
                          ><img
                            ...
                            "
                            class="sale-edit-product-image" /></q-avatar></q-item-section
                      ><q-item-section
                        ...
                        ></q-item-section
                      ><q-item-section side
                        ><div class="sale-edit-quantity-stepper row items-center no-wrap">
                          <q-btn
                            icon="remove"
                            color="negative"
                            flat
                          ...
                          /><q-input
                            ...
                            class="sale-edit-quantity-stepper__input"
                            type="number"
                            borderless
                            dense
                          /><q-btn
                          ...
                          /></div></q-item-section></q-item></q-list></q-card-section
              ></q-card>
            </div>
          </div>
        </q-card-section>
        <q-separator /><q-card-actions
          align="right"
          class="q-px-lg q-py-md bg-white"
...
.sale-edit-product-list {
  max-height: 410px;
}

.sale-edit-product-image {
  object-fit: cover;
}

.sale-edit-quantity-stepper {
  min-height: 36px;
  overflow: hidden;
...
.sale-edit-quantity-stepper__input {
  width: 42px;
  border-right: 1px solid #edf0f2;
  border-left: 1px solid #edf0f2;
}

.sale-edit-quantity-stepper__input :deep(.q-field__control) {
  min-height: 34px;
  height: 34px;
}

.sale-edit-quantity-stepper__input :deep(input) {
  width: 100%;
  padding: 0;
  text-align: center;
  font-weight: 700;
...
.sale-edit-quantity-stepper__input :deep(input::-webkit-inner-spin-button),
.sale-edit-quantity-stepper__input :deep(input::-webkit-outer-spin-button) {
  margin: 0;
