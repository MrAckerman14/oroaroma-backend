...
export async function reportRoutes(app: FastifyInstance) {
  ...
  app.put(
    ...
    async (request) => {
      ...
      return { data: await reports.updateClosure(request.authUser!, params.id, request.branchId, input) };
    }
  );
  ...
  app.put(
    ...
    async (request) => {
      ...
      return { data: await reports.updateClosureStatus(request.authUser!, params.id, request.branchId, input.status) };
    }
  );
  ...
  app.delete(
    ...
    async (request, reply) => {
      const params = idParamsSchema.parse(request.params);
      await reports.softDeleteClosure(request.authUser!, params.id, request.branchId);
